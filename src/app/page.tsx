...
export default function Home() {
  ...
  const [animatedClass,setAnimatedClass] = useState('opacity-0 bottom-[18%]')
  // const configLenis = ()=>{
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (isVideoPlay == 1) {
        ...
        setTimeout(() => {
          setAnimatedClass('opacity-1 bottom-[22%]')
        }, 37000);
        setVideoPlay(1);
        playVideo();
      }
  ...
  return (
    <div className='bg-[#0E1B37] relative min-h-screen overflow-scroll w-full'>
        ...
        <div className="flex flex-column z-1 relative w-full section-2 justify-center items-center">
          <div className="relative w-full justify-center items-center flex flex-row bg-[#0E1B37] overflow-hidden md:h-[100vh]">
